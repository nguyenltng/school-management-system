                    ...
                    <div class="box-header">
                        <div class="col-md-2" hidden>
                            <div class="form-group has-feedback">
                                {!! Form::select('section_id',  AppHelper::STUDENT_STATUS, $status , ['class' => 'form-control select2', 'id' => 'student_list_filter']) !!}
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group has-feedback">
                                {!! Form::select('status', ['0' => 'All'] + AppHelper::STUDENT_STATUS, $status , ['class' => 'form-control select2 student_list_filter', 'required' => 'true']) !!}
                            </div>
                        </div>
                        <div class="box-tools pull-right">
                            <a class="btn btn-info btn-sm" href="{{ URL::route('student.import') }}"><i class="fa fa-plus-circle"></i> Import File</a>
                        </div>
                        <div class="box-tools pull-right">
