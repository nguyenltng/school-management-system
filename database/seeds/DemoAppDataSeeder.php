...
class DemoAppDataSeeder extends Seeder
{
    ...
    private function userData(){
        $created_by = 1;
        $created_at = Carbon::now(env('APP_TIMEZONE','Asia/Ho_Chi_Minh'));
    ...
    private function instituteSettingsData()
    {
        ...
        $data['address'] = 'Dhanmondi, Ho_Chi_Minh-1207';
        ...
        $insertData = [
            ...
            ['meta_key' => 'board_name', 'meta_value' => 'Ho_Chi_Minh', 'created_by' => $created_by, 'created_at' => $created_at]
        ];
